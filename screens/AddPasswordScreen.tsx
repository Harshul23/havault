...
const AddPasswordScreen = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      showModal('Success', 'Password saved successfully!', 'success');
    } catch (error) {
      console.error('Failed to save password:', error);
      showModal('Error', 'Failed to save password. Please try again.', 'error');
    } finally {
      setIsSaving(false);
    }
  };
  ...
  const handleModalDismiss = (confirmed: boolean = false) => {
    ...
    // If it was a success message, navigate back
